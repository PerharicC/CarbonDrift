...
class CarbonDrift(OceanDrift):
    ...
    """An OceanDrift inherited class for tracking carbon particles, as they decay through clasical microbial decay and fragmentation.
    
    The microbial decay is goverened by the two coupled equations:
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.func = dist.choose_distribution(distribution)(dist)
        """
    ...
    def microbial_decay(self):
        return self.elements.mass * np.exp(-self.time_step.total_seconds() * self.decay_coef())
